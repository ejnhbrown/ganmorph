...
model = "128,100,5ep"
genfile = "models/gens/"+model+"_gen.pyt"
discfile = "models/disc/"+model+"_disc.pyt"
...
for epoch in range(num_epochs):
    ...
    for i, data in tqdm(enumerate(dataloader, 0)):
        ...
        if i % 50 == 0:
            ...
            torch.save(netG, "generator.pyt")
            torch.save(netD, "discriminator.pyt")
...
ani.save("ganmorph.mp4", writer=writer)
plt.show()
